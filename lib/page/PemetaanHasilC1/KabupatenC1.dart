...
class KabupatenC1 extends StatefulWidget {
  const KabupatenC1({super.key});

  @override
  State<KabupatenC1> createState() => _KabupatenC1State();
}

class _KabupatenC1State extends State<KabupatenC1> {
  TextEditingController carikab = TextEditingController();
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: textfieldsearch(
                      alamat: 'Kabupaten yang di cari ',
                      controllerUse: carikab,
                      onPressed: () {},
                    ),
                  ),
                ),
