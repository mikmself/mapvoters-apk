...
class DashboardService {
  Future<DashboardModel?> GetDashboardDetail(int id) async {
    try {
      var request = http.Request('GET', Uri.parse('$BASE_URL/get-dashboard-data/$id'));
      ...
      if (response.statusCode == 200) {
        ...
        if (responsDecode.containsKey('data')) {
          return DashboardModel.fromJson(responsDecode['data']);
        } else {
